...
Указать данные для доступа к БД:

- В файле main/settings.py в разделе 

```
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'netology_models_list', #Укажите имя БД
        'HOST': '127.0.0.1',
        'PORT': '5432',
        'USER': '', #Укажите имя пользователя для доступа к БД
        'PASSWORD': '' #Укажите пароль пользователя для доступа к БД
    }
}
```
